...
{"start_address": "Wrigley Field, Chicago",
 ...
 "pets": [{"name": "Rex", "address": "5218 N Clark St, Chicago",
           ...
           "comfort_min_f": 20,       // optional: comfort band, F
           "comfort_max_f": 84}]}     // (>=10F wide, within -20..110)
```
...
∈ {20, 30, 60}, buffer 0–60, comfort band within −20..110 and ≥10F wide, time `HH:MM`,
